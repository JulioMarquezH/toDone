    ...
    <div className="modal">
      <div className="modal-content">
        <button onClick={handleClose} className="close-btn">
          ...
          >
            <g clipPath="url(#clip0_21_681)">
              <path
                d="M15.293 7.29303L12 10.586L8.70703 7.29303L7.29303 8.70703L10.586 12L7.29303 15.293L8.70703 16.707L12 13.414L15.293 16.707L16.707 15.293L13.414 12L16.707 8.70703L15.293 7.29303Z"
                fill="#374957"
              />
              <path
